# undefine:D JavaScript Style Guide
...
### 이 문서는 idiomatic.js 를 기반으로 작성되었고, undefine:D 용으로 맞추었습니다. undefine:D 를 통해서 코드 작성에 참여할 때에는, 다음의 가이드라인을 따라야 합니다.

### 코드 작성 스타일을 강요하려는 의도는 아닙니다. 더 나은 방식이 있다면, 계속 수정해 나갑니다.
